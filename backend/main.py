...
app=FastAPI(title='AI School Timetable Generator',version='1.0.0')
app.add_middleware(CORSMiddleware,allow_origins=['*'],allow_credentials=True,allow_methods=['*'],allow_headers=['*'])
app.include_router(classes_router);app.include_router(teachers_router);app.include_router(subjects_router);app.include_router(slots_router);app.include_router(schedule_router);app.include_router(admin_router)
